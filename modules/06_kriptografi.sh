...
while true; do
    ...
    echo -e "${CYAN}  =================================================================${RESET}"
    echo ""
    echo -e "${GREEN}  [1] Teori Kriptografi${RESET}"
    echo -e "${GREEN}  [2] Praktik Hashing (MD5, SHA)${RESET}"
    echo -e "${GREEN}  [3] Enkripsi dengan OpenSSL${RESET}"
    echo -e "${GREEN}  [4] Caesar Cipher (Kriptografi Klasik)${RESET}"
